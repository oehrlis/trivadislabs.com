...
$DefaultPWDFile="C:\vagrant\config\default_pwd_win2019ad.txt"
...
Remove-DnsServerResourceRecord -ZoneName $domain -RRType "A" -Name "win2019ad" -Force
...
Add-DnsServerResourceRecordCName -Name "ad" -HostNameAlias "win2019ad.$domain" -ZoneName $domain
